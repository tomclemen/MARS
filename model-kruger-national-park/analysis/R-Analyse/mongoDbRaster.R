...
# Connect to mongodb
ticks <- c(550) # will be passed to mongo query

collectionRasterLayer <- "8ab39d16-a6b8-4d71-b11e-baa9620f86fe-KNPGISRasterVegetationLayer"
conLayer <- mongo(collectionRasterLayer, url = "mongodb://127.0.0.1:27017/ResultData")

collectionAgents <- "8ab39d16-a6b8-4d71-b11e-baa9620f86fe-kf"
...
png( file=gsub("*%TICK%*",520,outputPngFilename), height=1754, width=1240, res=150 )
