...
tick <- 1000
agentType <- "Elephant"
collection <- "f6ae7ad2-cfbf-4917-af79-263e102e2052-kf"
...
llBound <- c(30.5,-25.5)
urBound <- c(32.25,-21.75)
cellSizeInDeg <- 0.20

# output/input
png( file=sprintf("~/Downloads/agentdata-%s.png",yearTitlePng), height=825, width=595 )
...
bm_brk <- seq(0,400, by=50)
bm_col <- brewer.pal(length(bm_brk),"Greys")
